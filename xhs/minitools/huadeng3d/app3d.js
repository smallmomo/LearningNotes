...
(function () {
  ...
  const steps = [
    ...
    },
    {
      ...
      choices: [['plum', '梅花', '疏枝报春', '❀'], ['haitang', '海棠', '春睡含香', '✿'], ['yulan', '玉兰', '玉盏迎春', '❁'], ['starMoon', '星月', '灯映星河', '☾'], ['baoxiang', '宝相花', '宫灯团花', '✾'], ['bamboo', '翠竹', '竹报平安', '🎋'], ['orchid', '幽兰', '空谷吐芳', '🌿'], ['cloud', '流云', '云卷舒心', '≋'], ['fish', '双鱼', '年年有余', '🐟'], ['willow', '雪柳', '柳丝依依', '❄'], ['fortune', '纳福', '福气常在', '福'], ['plain', '素面', '留一分空白', '·']]
    },
    {
