  ...
  const steps = [
    {
      ...
      choices: [['round', '团圆灯', '圆鼓饱满', '◯'], ['melon', '南瓜灯', '瓣瓣分明', '❋'], ['lotus', '莲花灯', '瓣瓣舒展', '✿'], ['sittingRabbit', '玉兔灯', '侧坐舒耳', '🐇'], ['rabbit', '兔子灯', '双耳竖立', '🐇'], ['tall', '长圆灯', '修长雅致', '⬭'], ['barrel', '桶子灯', '憨直敦实', '⬢'], ['globe', '圆球灯', '饱满团圆', '●'], ['oval', '筒子灯', '清瘦修长', '▮'], ['hex', '棱角灯', '六面生光', '⬡'], ['palace', '六角宫灯', '飞檐垂穗', '⬡'], ['koi', '锦鲤灯', '游鱼衔福', '鱼']]
    },
    {
